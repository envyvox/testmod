...
public class KeyBinding {
    ...
    public static final String KEY_CATEGORY_TUTORIAL = "key.category.testmod.tutorial";
    public static final String KEY_DRINK_WATER = "key.category.testmod.drink_water";
